...
class Configuracion:
    ...
    def __init__(self):
        ...
        self.__BATERIA_BAJA = 10  # porcentaje
        self.__POTENCIA_ALTA = 2000  # watts
        self.__POTENCIA_BAJA = 100  # watts
        
        # Wi-Fi
        self.__WIFI_SSID = 'rocca'
        self.__WIFI_PASSWORD = 'dobla es el goat'
...
class Bateria:
    ...
    def __init__(self, config):
        self.config = config
        self.curva_descarga = [
            (50.8, 100), (48.8, 90), (46.8, 80),
            (44.8, 70), (42.8, 60), (40.8, 50),
            (38.8, 40), (36.8, 30), (34.8, 20),
            (32.8, 10), (30.8, 0)
        ]
